...
my $VERSION = sprintf "%d.%03d", q$Revision: 431763 $ =~ /(\d+)/g;
my $verbose;
...
#
   ...
   # \RCS$Revision: 431763 $
   # \RCS$Date: 2017-10-30 21:58:10 +0100 (Mon, 30 Oct 2017) $
   # \RCS$HeadURL: svn+ssh://svn.cern.ch/reps/tdr2/utils/branches/dev8/general/makeManifest.pl $
   # \RCS$Id: makeManifest.pl 431763 2017-10-30 20:58:10Z alverson $
